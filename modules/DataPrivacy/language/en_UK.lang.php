...
$mod_strings = array(
    ...
    'LBL_WARNING_COMPLETE_CONFIRM' => 'You are about to mark this request as completed. This will permanently set the status to Completed and it cannot be reopened. Are you sure you want to proceed?',
    'LBL_WARNING_REJECT_REQUEST_CONFIRM' => 'You are about to mark this request as rejected. This will permanently set the status to Rejected and it cannot be reopened. Are you sure you want to proceed?',
