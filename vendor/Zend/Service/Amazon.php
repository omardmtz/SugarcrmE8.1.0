 ...
 */
require_once 'vendor/Zend/Rest/Client.php';
...
class Zend_Service_Amazon
{
    ...
    public function __construct($appId, $countryCode = 'US', $secretKey = null)
    {
        ...
        if (!isset($this->_baseUriList[$countryCode])) {
             ...
             */
            require_once 'vendor/Zend/Service/Exception.php';
    ...
    public function itemSearch(array $options)
    {
         ...
         */
        require_once 'vendor/Zend/Service/Amazon/ResultSet.php';
    ...
    public function itemLookup($asin, array $options = array())
    {
        ...
        if ($items->length == 1) {
             ...
             */
            require_once 'vendor/Zend/Service/Amazon/Item.php';
    ...
    {
        require_once "vendor/Zend/Crypt/Hmac.php";
