 ...
 */
require_once 'vendor/Zend/Gdata/App/Extension.php';
 ...
 */
require_once 'vendor/Zend/Gdata/Extension/When.php';

/**
 * @see Zend_Gdata_Extension_Who
 */
require_once 'vendor/Zend/Gdata/Extension/Who.php';

/**
 * @see Zend_Gdata_Extension_Recurrence
 */
require_once 'vendor/Zend/Gdata/Extension/Recurrence.php';

/**
 * @see Zend_Gdata_Extension_EventStatus
 */
require_once 'vendor/Zend/Gdata/Extension/EventStatus.php';
 ...
 */
require_once 'vendor/Zend/Gdata/Extension/Transparency.php';

/**
 * @see Zend_Gdata_Extension_Visibility
 */
require_once 'vendor/Zend/Gdata/Extension/Visibility.php';

/**
 * @see Zend_Gdata_Extension_ExtendedProperty
 */
require_once 'vendor/Zend/Gdata/Extension/ExtendedProperty.php';

/**
 * @see Zend_Gdata_Extension_OriginalEvent
 */
require_once 'vendor/Zend/Gdata/Extension/OriginalEvent.php';

/**
 * @see Zend_Gdata_Extension_EntryLink
 */
require_once 'vendor/Zend/Gdata/Extension/EntryLink.php';
