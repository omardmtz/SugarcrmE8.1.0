...
/** Zend_Oauth */
require_once 'vendor/Zend/Oauth.php';

/** Zend_Uri */
require_once 'vendor/Zend/Uri.php';

/** Zend_Oauth_Http_RequestToken */
require_once 'vendor/Zend/Oauth/Http/RequestToken.php';

/** Zend_Oauth_Http_UserAuthorization */
require_once 'vendor/Zend/Oauth/Http/UserAuthorization.php';

/** Zend_Oauth_Http_AccessToken */
require_once 'vendor/Zend/Oauth/Http/AccessToken.php';

/** Zend_Oauth_Token_AuthorizedRequest */
require_once 'vendor/Zend/Oauth/Token/AuthorizedRequest.php';

/** Zend_Oauth_Config */
require_once 'vendor/Zend/Oauth/Config.php';
...
class Zend_Oauth_Consumer extends Zend_Oauth
{
    ...
    public function getAccessToken(
        ...
        if (!$authorizedToken->isValid()) {
            require_once 'vendor/Zend/Oauth/Exception.php';
